    ...
    <div class="login flex flex-col">
        <div class="flex-1 flex items-center justify-center">
            <div class="login-card flex rounded-md">
                <div class="flex-1 h-full hidden md:inline-block" style="background-color: #409eff">
<!--                    <image-contain :src="config.login_image" :width="400" height="100%" />-->
                    <Vue3Lottie :animationData="CarJSON" class="vue3Lottie" />
                </div>
                <div
...
import CarJSON from '@/utils/location.json'
