...
<!--                    <el-table-column label="关联商品" prop="goods_name" show-overflow-tooltip />-->
                    ...
                    <el-table-column label="操作" width="120" fixed="right">
                        <template #default="{ row }">
                            ...
                            <el-button
                                    v-perms="['good.combination/delete']"
                                    type="danger"
                                    link
...
import { apiCombinationLists, apiGoodEdit, apiGoodDelete,apiCombinationEdit } from '@/api/good'
