    ...
    <div class="edit-popup">
        <popup ref="popupRef" :title="popupTitle" :async="true" width="700px" @confirm="handleSubmit"
            ...
            <el-form ref="formRef" :model="formData" label-width="100px" :rules="formRules">
                ...
                <el-col :span="12">
                    <el-form-item label="当前库存" prop="bstock">
                        <el-input v-model="formData.bstock" clearable type="number" :disabled="true"/>
                    </el-form-item>
                </el-col>
...
import { apiGoodsStockBstock } from '@/api/goods_stock'
...
const handleSubmit = async () => {
    try {
        ...
        const data = { ...formData, }
        mode.value == await apiGoodsStockBstock(data)
