      ...
      >
        ...
        <el-form-item label="活动图片" prop="img">
          ...
          <el-row v-for="(item, index) in formData.good" :key="index">
              <el-form-item label="商品" :prop="`good.${index}.good_id`" :rules="formRules.good_id" style="width: 400px">
              ...
              <el-form-item label="价格" :prop="`good.${index}.price`" :rules="formRules.price" style="width: 300px;margin-left: -53px">
                  <el-input-number v-model="item.price" clearable placeholder="" style="width:120px"/>
              </el-form-item>
              <el-form-item label="库存" :prop="`good.${index}.stock`" :rules="formRules.stock"  style="width: 300px;margin-left: -110px">
