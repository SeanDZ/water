        ...
        <el-card class="!border-none" v-loading="pager.loading" shadow="never">
            <div class="mt-4">
                <el-table :data="pager.lists" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="订单号" prop="trade_no" show-overflow-tooltip width="280"/>
                    ...
                    <el-table-column label="操作" width="180" fixed="right">
                        <template #default="{ row }">
                            <el-button v-perms="['order.shop_order_month/detail']" type="primary" link>
                                <router-link
                                    :to="{
                                    path: 'shop_order_month/detail', //菜单->路由路径
                                    query: {
                                        id: row.id
                                    }
                                }"
...
import { apiShopOrderMonthLists, apiShopOrderDelete } from '@/api/shop_order'
...
const { pager, getLists, resetParams, resetPage } = usePaging({
    fetchFun: apiShopOrderMonthLists,
    params: queryParams
})
