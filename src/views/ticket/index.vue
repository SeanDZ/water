    ...
    <el-card class="!border-none" v-loading="pager.loading" shadow="never">
      ...
      <div class="mt-4">
        <el-table :data="pager.lists" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="套餐" prop="taocan" show-overflow-tooltip />
...
import { apiTicketLists, apiGoodEdit, apiGoodDelete } from '@/api/good'
